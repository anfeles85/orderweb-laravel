...
class ReportController extends Controller
{
    ...
    /**
     * exporta todos los usuarios existentes en PDF
     */
    ...
    /**
     * exporta las actividades de un técnico seleccionado
     */
    ...
    /**
     * exporta las ordenes dado un rango de fechas
     */
    public function export_orders(Request $request)
    {
        ...
        $pdf = Pdf::loadView('reports.export_orders', $data)
                    ->setPaper('letter', 'portrait');
